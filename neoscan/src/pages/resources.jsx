    ...
    <div className="bg-white p-6 rounded-md shadow-lg text-center w-96 mx-auto mt-10">
      ...
      <div className="my-4">
        ...
        <ul className="space-y-2">
          <li><a href="https://www.who.int" target="_blank" className="text-blue-500 underline">WHO - Cancer Research</a></li>
          <li><a href="https://www.cancer.org" target="_blank" className="text-blue-500 underline">American Cancer Society</a></li>
          <li><a href="https://learn.microsoft.com/en-us/azure/healthcare/" target="_blank" className="text-blue-500 underline">Microsoft Health AI</a></li>
        </ul>
      </div>
      ...
      <ul className="space-y-2">
        <li><a href="https://www.medicalnewstoday.com/articles/cancer-symptoms" target="_blank" className="text-blue-500 underline">Early Signs of Cancer</a></li>
        <li><a href="https://www.cancer.gov/about-cancer/prevention" target="_blank" className="text-blue-500 underline">Cancer Prevention Strategies</a></li>
        <li><a href="https://www.nhs.uk/conditions/cancer/" target="_blank" className="text-blue-500 underline">Understanding Different Types of Cancer</a></li>
      </ul>
